...
def team():
    if request.method == "POST":
        ...
        # Validate form data (uncomment and improve as needed)
        # if not first_name or not last_name or not gender or not email or not mobile_number or not address or not occupation or not occupation_address or not education or not about or not make_change or not aadhar_number or not pan_number or not aadhar_card or not pan_card or not photo:
